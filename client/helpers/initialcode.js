export const initialcode=`import { Footnote, PageBottom, Tailwind, CSS } from "@onedoc/react-print";
  ...
  \`}
      ...
      <div className="font-[inter] text-slate-800">
        ...
        <div className="flex items-start">
          ...
          <div className="flex-grow" />
          <div className="bg-blue-500 shadow-xl ring-white ring-4 shadow-blue-500/20 text-white p-1  rounded-[0.625rem] w-1/2">
